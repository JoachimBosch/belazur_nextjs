    ...
    return (
        ...
        >
            <div className="text-left">
                <h1 className="text-center ">Politique relative aux cookies</h1>
                <p>
                ...
                <p>
                    ...
                    visites récurrentes (en utilisant un “cookie persistant”).
                </p>
                <p>
                    Les cookies de session sont des cookies temporaires utilisés
                    pendant votre visite sur le Site web et expirent lorsque
                    vous fermez le navigateur web.
                </p>
                <p>
                    Les cookies persistants sont utilisés pour mémoriser vos
                    préférences au sein de notre Site web et restent sur votre
                    ordinateur de bureau ou appareil mobile même après la
                    fermeture de votre navigateur ou le redémarrage de votre
                    ordinateur. Ils assurent une expérience cohérente et
                    efficace pour vous lors de votre visite sur le Site web et
                    les Services.
                </p>
                <p>
                ...
                <h2
                    id="quels-types-de-cookies-utilisons-nous"
                    className="pt-12"
                >
                    Quels types de cookies utilisons-nous?
                </h2>
                ...
                <h3>Cookies des médias sociaux</h3>
                <p>
                ...
                <h2
                    id="quelles-sont-vos-options-en-mati%c3%a8re-de-cookies"
                    className="pt-12"
                >
                    Quelles sont vos options en matière de cookies ?
                </h2>
                ...
                <p>
                    ...
                    discrétion, comme par le biais des coordonnées que vous avez
                    fournies.
                </p>
                <p>
